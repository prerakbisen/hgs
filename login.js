...
async function loginUserBackend(email, password) {
    try {
        const res = await fetch("https://hgsbackend-production.up.railway.app/api/auth/login", {
            method: "POST",
...
async function registerUserBackend(userObj) {
    try {
        const res = await fetch("https://hgsbackend-production.up.railway.app/api/auth/register", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
function initForgotPassword() {
    ...
    sendOtpBtn?.addEventListener('click', async () => {
        ...
        try {
            const res = await fetch('https://hgsbackend-production.up.railway.app/api/auth/forgot/request', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    resetBtn?.addEventListener('click', async () => {
        ...
        try {
            const res = await fetch('https://hgsbackend-production.up.railway.app/api/auth/forgot/reset', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
